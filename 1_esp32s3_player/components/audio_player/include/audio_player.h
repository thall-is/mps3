...
// Rescaneia a pasta de navegacao/playlist atuais (o conteudo do cartao
// pode ter mudado enquanto estava exposto via USB) e retoma a reproducao.
// Chamado quando o host USB desconecta e o cartao e' remontado.
