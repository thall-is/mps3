...
Monitor sincronizado multi-porta serial para o sistema de áudio mps3:
  - ESP32-S3 (Placa Principal / Player): auto-detectado ou configurado
  - ESP32 Classic (Co-Processador bt_companion): auto-detectado ou configurado
  - ESP32 Classic (Receptor de Teste bt_audio_sink): auto-detectado ou configurado

Uso:
  python testbench_monitor.py [--s3 COMX] [--comp COMY] [--sink COMZ] [--baud 115200]
"""
