...
const document = {
    ...
    createElement: function() { return { style: {}, classList: { add: function(){}, remove: function(){} }, querySelector: function() { return {onclick:null}; } }; },
    addEventListener: function() {},
};
const window = { addEventListener: function(){} };
const navigator = {};
const fetch = async function() {};
const URL = { createObjectURL: function() {} };
class AudioContext { createMediaElementSource() { return { connect: function(){} }; } }
        ...
        function toggleListenerPlay() {
            if (radioAudio.paused) {
                radioAudio.src = 'http://' + window.location.hostname + ':8000/?t=' + Date.now();
                radioAudio.play();
                document.getElementById('listenerPlayBtn').innerHTML = '<svg fill="currentColor" viewBox="0 0 24 24" width="32" height="32"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>';
            } else {
                radioAudio.pause();
                radioAudio.src = ''; // disconnect stream
                document.getElementById('listenerPlayBtn').innerHTML = '<svg fill="currentColor" viewBox="0 0 24 24" width="32" height="32"><path d="M8 5v14l11-7z"/></svg>';
            }
        }
                ...
                document.getElementById('listener-view').style.display = 'flex';
                document.getElementById('dj-view').style.display = 'none';
                el.artListener = document.getElementById('listenerArt');
                el.artListener.src = defaultCover;
            }
        }
